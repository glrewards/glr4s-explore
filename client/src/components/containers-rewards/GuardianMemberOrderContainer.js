/*
* this container is similar to the memberordercontainer but it has do a few thins.
* 1. it has to work out which related member to get the order for
* 2. it has to fetch the order
* 3. it has to retrieve the order
* 4. when handling amendments it has to ensure the correct user data is passed
*
 */
...
class GuardianMemberOrderContainer extends Component {
  constructor(props) {
    super(props);
...
GuardianMemberOrderContainer.propTypes = {
...
export default connect(mapStateToProps)(GuardianMemberOrderContainer);
