...
class ApiClient {
    constructor() {
         ...
         * @type {String}
         * @default https://virtserver.swaggerhub.com/Copper-Beech/GLR-4-Schools/1.0.1-oas3
         */
        this.basePath = 'https://virtserver.swaggerhub.com/Copper-Beech/GLR-4-Schools/1.0.1-oas3'.replace(/\/+$/, '');
  ...
  /**
    ...
    */
    hostSettings() {
        return [
            {
              'url': "https://virtserver.swaggerhub.com/Copper-Beech/GLR-4-Schools/1.0.1-oas3",
              'description': "SwaggerHub API Auto Mocking",
            },
            {
              'url': "https://virtserver.swaggerhub.com/Copper-Beech/GLR-4-Schools/1.0.0",
